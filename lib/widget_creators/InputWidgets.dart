...
class InputWidgets{
  ...
  Checkbox buildCheckboxInput(String text){
    //TODO
    return null;
  }

  /// Build a list of checkboxes with the given list of options
  Widget buildListOfCheckboxes(List<String> options){
    //TODO
    return null;
  }

  /// Build a radio button with the given text
  Radio buildRadioButton (String text){
    //TODO
    return null;
  }

  /// Build a list of radio buttons with the list of options
  Widget buildListOfRadios(List<String> options){
    //TODO
    return null;
  }
}